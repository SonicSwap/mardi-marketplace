 ...
 */
contract HarmonyAuction is OwnableUpgradeable, ReentrancyGuardUpgradeable {
    using SafeMath for uint256;
    using AddressUpgradeable for address payable;
    using SafeERC20 for IERC20;

    /// @notice Event emitted only on construction. To be used by indexers
    event HarmonyAuctionContractDeployed();
        ...
        initializer
    {
        require(
            ...
            "HarmonyAuction: Invalid Platform Fee Recipient"
        );

        platformFeeRecipient = _platformFeeRecipient;
        emit HarmonyAuctionContractDeployed();
 ...
 */
    ...
    function placeBid(
        ...
        require(
            ...
            "ERC20 method used for ONE auction"
        );
        ...
        nonReentrant
    {
        ...
        IHarmonyMarketplace marketplace = IHarmonyMarketplace(
        ...
        emit AuctionResulted(
            ...
            winner,
            auction.payToken,
            IHarmonyMarketplace(addressRegistry.marketplace()).getPrice(
                auction.payToken
            ),
            winningBid
        );
